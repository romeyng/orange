...
class InventoryContent extends Component {
 ...
 async componentDidMount() {
   Axios.post("http://52.15.62.203:8080/getFuelRecon", {location: this.props.selectedLocation})
   .then(response => {
  ...
  fillReconTable() {
    $(this.refs.tickets).DataTable({
      ...
      columns: [
        ...
        { title: "Customer", data: "customer_name" },//sql join csutomers table for name
        ...
        { title: "XCD Balance", data: "xcd_balance"},
        ...
        <div className="row">
          <div className="table-responsive-sm table-responsive-md table-responsive-lg table-responsive-xl">
            <div className="bgc-white bd bdrs-3 p-20 mB-20">
              <h4 className="c-grey-900 mB-20"> Fuel Recon {this.props.selectedLocation} </h4>
