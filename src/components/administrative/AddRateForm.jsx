...
class AddRate extends Component {
    constructor(props) {
        ...
        customerID: "0", locationID: "", fuelType:"choose", locOptions:[], customerOptions:[],showCustomerLookup:false };
    ...
    componentDidMount() {
      axios.get("http://52.15.62.203:8080/getlocations")
      .then(({ data }) => {
        var arr=[];
        for (var k = 0; k < data.length; k++) {
          arr.push(<option key={data[k].locationID} value={data[k].locationID}> {data[k].airport_code} </option>);
      }
        this.setState({
          locOptions: arr
        });
          ...
          <div className="bgc-white bd m-3 p-4">
            <div className="row">
              ...
              <label htmlFor="locationID">Location</label>
                <select className="custom-select form-control form-control-lg" name="locationID"
            ...
            <div className="row">
              <div className="col-3">
                ...
                <select className="custom-select form-control form-control-lg" name="fuelType"
              ...
              Rate Type
                ...
                />
                <label className="form-check-label" htmlFor="ratereg">Regular</label>
                </div>
                <div className="form-check">
                <input
                type="radio"
                ...
                value="prepaid"
                />
                 <label className="form-check-label" htmlFor="ratepp">Prepaid</label>
              </div>
              </div>
              <div className="col-5">
             <CustomersDropDown classList="custom-select form-control form-control-lg" selectedCustomer={this.handleCustomer}/>
              </div>
            ...
            <div className="bgc-white bd m-3 mB-5 pT-4">
             <div className="row">
              ...
              <div className="col-1"><br/><br/>per</div>
              <div className="col-2">
                <label htmlFor="unitDesc">Unit</label>
                <select className="custom-select form-control form-control-lg" name="unitDesc"
